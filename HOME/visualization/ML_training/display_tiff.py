...
folders = [
    [
        root_dir + "/data/archive/topredict/train/image/",
        root_dir + "/data/archive/topredict/predictions/BW_RGB_training/",
        root_dir + "/data/archive/topredict/predictions/BW/",
        root_dir + "/data/archive/topredict/predictions/BW_poor_training/",
        root_dir + "/data/archive/topredict/predictions/BW_augmented/",
    ],
    [
        root_dir + "/data/archive/topredict/train/image/",
        root_dir + "/data/archive/topredict/predictions/BW_RGB_training/",
