...
def parse_args():
    ...
    parser.add_argument("--DataSet", default="NOCI_BW")
    parser.add_argument("--image-folder", default="train_BW/image")
...
if __name__ == "__main__":
    args = parse_args()
    dir_checkpoint = str(root_dir) + "/data/ML_model/save_weights/run_5/"
